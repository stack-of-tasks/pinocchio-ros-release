## pinocchio (noetic) - 3.3.0-1

The packages in the `pinocchio` repository were released into the `noetic` distro by running `/nix/store/ai12rs6v9d4pfsj8m2k668zbnr7z8l57-python3.12-bloom-0.12.0/bin/bloom-release -r noetic pinocchio` on `Sun, 08 Dec 2024 20:59:02 -0000`
...
## pinocchio (noetic) - 2.6.21-1

The packages in the `pinocchio` repository were released into the `noetic` distro by running `/tmp/venv/bin/bloom-release --rosdistro noetic pinocchio` on `Sun, 03 Dec 2023 15:28:27 -0000`
...
## pinocchio (noetic) - 2.6.17-1

The packages in the `pinocchio` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic --non-interactive pinocchio` on `Wed, 15 Feb 2023 20:41:32 -0000`
...
## pinocchio (noetic) - 2.6.16-1

The packages in the `pinocchio` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic --non-interactive pinocchio` on `Fri, 03 Feb 2023 10:29:33 -0000`
...
## pinocchio (melodic) - 2.6.16-1

The packages in the `pinocchio` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic --non-interactive pinocchio` on `Fri, 03 Feb 2023 10:25:44 -0000`
...
## pinocchio (noetic) - 2.6.15-1

The packages in the `pinocchio` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic --non-interactive pinocchio` on `Wed, 01 Feb 2023 00:25:21 -0000`
...
## pinocchio (melodic) - 2.6.15-1

The packages in the `pinocchio` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic --non-interactive pinocchio` on `Wed, 01 Feb 2023 00:20:25 -0000`
